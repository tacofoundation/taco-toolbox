...
class TestSTACValidation:
    ...
    def test_rejects_time_start_after_time_end(
        self, utm_crs, utm_geotransform, tensor_shape_3band, timestamp_2024, timestamp_2024_end
    ):
...
class TestSTACAutoPopulation:
    ...
    def test_preserves_explicit_centroid(
        self, utm_crs, utm_geotransform, tensor_shape_3band, timestamp_2024, wkb_point_wgs84
    ):
        ext = STAC(
            crs=utm_crs,
            geotransform=utm_geotransform,
